...
1. **`data/`** folder:
   ...
   Note: these rollout data can also be generated by running `llama8b_correct_model.py` and `llama8b_series_model.py` in `generation_and_scoring` folder. You can change the backbone by modifying the model name when loading from huggingface.
